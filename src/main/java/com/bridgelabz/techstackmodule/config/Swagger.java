package com.bridgelabz.techstackmodule.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.techstackmodule.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("techstackmodule",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("techstackmodule", "http://bridgelabz.techstackmodule", "swasthikkj@gmail.com"),
                "Apache 2.0",
